...
const endpointRows = [
  ...
  ['POST', '/api/images/bulk-used', 'WEBAPP MULTI-SELECTION — stamp many images and/or upscale variants in one request. Body { used: true|false, image_ids?: [], upscales?: [{ image_id, upscale_id }] } → { data: { marked, images[], missing[] } }', true],
